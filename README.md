...
fix the poke ball catching mini game by placing the button exactly the same way as in pokemon go (add relevant background to the catching mini game depending on area.
